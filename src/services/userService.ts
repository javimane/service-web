...
export const userService = {
   ...
   */
  getFavorites: () => 
    apiClient<{ data: any[]; count: number; page: number; limit: number; totalPages: number }>(API_ENDPOINTS.users.favorites, {
      method: "GET",
    }),
  ...
  removeFavorite: (professionalId: string | number) => 
    apiClient<void>(API_ENDPOINTS.users.favoriteDetail(professionalId.toString()), {
      method: "DELETE",
    }),
