...
import { plans as staticPlans, mergePlansWithSubscriptionPrices } from "../../data/plans";
import { getSubscriptionPricesAction } from "@/app/actions/plans";
import { getMercadoPagoPlansAction, createMercadoPagoSubscriptionAction } from "@/app/actions/mercadopago";
...
export default function RegisterPlanSelection() {
  ...
  const handleSelectPlan = async (planId: string) => {
    ...
    try {
      ...
      if (!mpPlanId) {
        ...
        router.push(ROUTES.dashboard); // Redirect anyway if error
        return;
      }
  ...
  return (
    <div className="subscription-plans" style={{ background: "var(--bg-color)", padding: "24px", borderRadius: "var(--radius-xl)", maxWidth: "1000px", width: "100%", margin: "auto" }}>
      <h2 className="subscription-plans__title" style={{ textAlign: "center", marginBottom: "var(--space-6)" }}>Elegí tu plan profesional</h2>
