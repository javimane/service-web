          ...
          <div className="professional-profile__card">
              ...
              <button
                ...
                title={
                  subscriptionPlan === "free"
                    ? "Subir videos solo está disponible en los planes Básico y Premium"
                    : undefined
                }
              >
                Agregar video
            ...
            {subscriptionPlan === "free" && (
              <p className="professional-profile__video-note">
                * La subida de videos de presentación solo está disponible para
                los planes Básico y Premium.
              </p>
            )}
