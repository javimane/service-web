    ...
    <section className="showcase">
      <div className="showcase__inner">
        ...
        <div className="showcase__profile">
          <Link href={ROUTES.profile} className="showcase__avatar-link">
            <img
        ...
        <div className="showcase__content">
          ...
          <div className="showcase__testimonials">
            {testimonials.map((t, index) => (
              <blockquote key={`${t.author}-${index}`} className="testimonial">
                <div className="testimonial__header">
                  <span className="testimonial__author">{t.author}</span>
                  <span className="testimonial__rating">{"★".repeat(5)}</span>
                </div>
