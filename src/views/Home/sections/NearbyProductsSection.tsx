                ...
                >
                  ...
                  <div className="nearby-product-card__body">
                    <div className="nearby-product-card__seller-row">
                      <img
                        src={
                          item.Professional?.Profile?.avatar_url ||
                          `https://ui-avatars.com/api/?name=${encodeURIComponent(item.Professional?.Profile?.display_name || "P")}`
                        }
                      ...
                      <span className="nearby-product-card__seller-name">
                        {item.Professional?.Profile?.display_name ||
