      ...
      <main className="favorites-page__main container">
        <header className="favorites-page__header">
          ...
          <div className="favorites-title-wrap">
            <Heart className="favorites-icon-glow" size={32} fill="var(--accent-primary)" stroke="var(--accent-primary)" />
            <h1 className="favorites-title">Tus Favoritos</h1>
          </div>
          <p className="favorites-subtitle">
            Gestioná tus profesionales prefereidos para contactarlos rápidamente.
          </p>
        </header>
            ...
            <div className="favorites-list">
              {favorites.map((professional) => (
                <div 
                  ...
                  onClick={() => navigate(`${ROUTES.profile}?id=${professional.id}`)}
                >
                  <div className="favorite-item__avatar-wrap">
                    ...
                    {professional.verified && (
                      <div className="favorite-item__verified" title="Verificado">
                  ...
                  <div className="favorite-item__info">
                    <div className="favorite-item__header">
                      <h3 className="favorite-item__name">{professional.name}</h3>
                      <span className="favorite-item__specialty">{professional.specialty}</span>
                    </div>
                    
                    <div className="favorite-item__meta">
                      <div className="meta-pill">
                        <Star size={14} fill="var(--star-color)" stroke="var(--star-color)" />
                        <span>{professional.rating}</span>
                        <span className="meta-count">({professional.reviews})</span>
                      </div>
                      <div className="meta-pill">
                        <MapPin size={14} />
