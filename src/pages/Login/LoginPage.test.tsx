...
describe('LoginPage', () => {
  ...
  it('se renderiza correctamente', () => {
    ...
    expect(screen.getByPlaceholderText('arquitecto@obsidian.pro')).toBeInTheDocument();
  ...
  it('muestra error de formato de email', () => {
    ...
    expect(screen.getByText('El formato del correo es inválido')).toBeInTheDocument();
  });
