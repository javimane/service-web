...
export default function CalendarSection() {
  ...
  const hasCredentials = !!import.meta.env.VITE_GOOGLE_CLIENT_ID;
      ...
      {!hasCredentials && (
        <div className="cal-notice">
          ...
          <div>
            ...
            <p>
              Agregá <code>VITE_GOOGLE_CLIENT_ID</code> y{" "}
              <code>VITE_GOOGLE_API_KEY</code> a tu archivo <code>.env</code>{" "}
