...
export const getMercadoPagoPlansAction = publicAction.action(async ({ ctx }) => {
  const url = `${env.NEXT_PUBLIC_API_BASE_URL}/api/mercadopago/plans`;
...
export const createMercadoPagoSubscriptionAction = publicAction
  ...
  .action(async ({ parsedInput, ctx }) => {
    const url = `${env.NEXT_PUBLIC_API_BASE_URL}/api/mercadopago/create`;
...
export const cancelMercadoPagoSubscriptionAction = publicAction.action(async ({ ctx }) => {
  const url = `${env.NEXT_PUBLIC_API_BASE_URL}/api/mercadopago/cancel`;
