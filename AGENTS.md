...
@media (max-width: 1024px) { /* desktop chico */ }
@media (max-width: 1280px) { /* wide */ }
```
...
| `--border-color` | `#e9ecef` | Bordes generales |
...
export default function ComponentName({ title, variant = "default" }: ComponentNameProps) {
  return (
